...
class WhenCommitTimeIsBetween0And30MinutesTest {
    ...
    void thenStartTimeIs0MinuteAndEndTimeIs30Minutes() {
        ...
        assertThat(baingaWagesCalculator.dailyTasks().get(0).pomodoroList().get(0).start()).isEqualTo(LocalDateTime.of(2023, Month.APRIL, 5, 22, 0));
        assertThat(baingaWagesCalculator.dailyTasks().get(0).pomodoroList().get(0).end()).isEqualTo(LocalDateTime.of(2023, Month.APRIL, 5, 22, 30));
    }
